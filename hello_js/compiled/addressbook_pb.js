...
goog.exportSymbol('proto.tutorial.Person.PhoneNumber.PhoneType', null, global);
...
proto.tutorial.Person.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      msg.getPhonesList().push(value);
      msg.setPhonesList(msg.getPhonesList());
      break;
    default:
      reader.skipField();
      break;
...
/** @param {Array.<!proto.tutorial.Person.PhoneNumber>|undefined} value  */
...
proto.tutorial.Person.PhoneNumber.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    type: jspb.Message.getField(msg, 2) == null ? 1 : jspb.Message.getField(msg, 2)
  };
...
proto.tutorial.Person.PhoneNumber.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.tutorial.Person.PhoneNumber.PhoneType} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.tutorial.Person.PhoneNumber.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getNumber();
  if (f != null) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.tutorial.Person.PhoneNumber} The clone.
 */
proto.tutorial.Person.PhoneNumber.prototype.cloneMessage = function() {
  return /** @type {!proto.tutorial.Person.PhoneNumber} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {proto.tutorial.Person.PhoneNumber.PhoneType}
 */
proto.tutorial.Person.PhoneNumber.prototype.getType = function() {
  return /** @type {proto.tutorial.Person.PhoneNumber.PhoneType} */ (jspb.Message.getField(this, 2) == null ? 1 : jspb.Message.getField(this, 2));
};


/** @param {proto.tutorial.Person.PhoneNumber.PhoneType|undefined} value  */
 ...
 * @enum {number}
 */
proto.tutorial.Person.PhoneNumber.PhoneType = {
  MOBILE: 0,
  HOME: 1,
  WORK: 2
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.tutorial.AddressBook.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.tutorial.AddressBook} The clone.
 */
proto.tutorial.AddressBook.prototype.cloneMessage = function() {
  return /** @type {!proto.tutorial.AddressBook} */ (jspb.Message.cloneMessage(this));
};
...
/** @param {Array.<!proto.tutorial.Person>|undefined} value  */
