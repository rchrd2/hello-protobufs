...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='tutorial',
  syntax='proto2',
  serialized_pb=_b('\n\x11\x61\x64\x64ressbook.proto\x12\x08tutorial\"\xe8\x01\n\x06Person\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\x05\x12\r\n\x05\x65mail\x18\x03 \x01(\t\x12,\n\x06phones\x18\x04 \x03(\x0b\x32\x1c.tutorial.Person.PhoneNumber\x1a\x86\x01\n\x0bPhoneNumber\x12\x0e\n\x06number\x18\x01 \x01(\t\x12:\n\x04type\x18\x02 \x01(\x0e\x32&.tutorial.Person.PhoneNumber.PhoneType:\x04HOME\"+\n\tPhoneType\x12\n\n\x06MOBILE\x10\x00\x12\x08\n\x04HOME\x10\x01\x12\x08\n\x04WORK\x10\x02\"/\n\x0b\x41\x64\x64ressBook\x12 \n\x06people\x18\x01 \x03(\x0b\x32\x10.tutorial.Person')
)
_sym_db.RegisterFileDescriptor(DESCRIPTOR)



_PERSON_PHONENUMBER_PHONETYPE = _descriptor.EnumDescriptor(
  name='PhoneType',
  full_name='tutorial.Person.PhoneNumber.PhoneType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_PERSON_PHONENUMBER_PHONETYPE)
...
_PERSON_PHONENUMBER.fields_by_name['type'].enum_type = _PERSON_PHONENUMBER_PHONETYPE
_PERSON_PHONENUMBER.containing_type = _PERSON
_PERSON_PHONENUMBER_PHONETYPE.containing_type = _PERSON_PHONENUMBER
